      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
            <div style={{ padding: '0.6rem', backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: 'var(--radius-md)' }}>
              {headerConfig.icon}
            </div>
            <div>
          ...
          <button 
            onClick={onClose}
            style={{ backgroundColor: 'transparent', border: 'none', color: 'white', cursor: 'pointer', padding: '0.4rem' }}
          >
            <X size={24} />
          </button>
        </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '1rem', flexWrap: 'wrap' }}>
            <div style={{ position: 'relative', flex: 1, minWidth: '280px' }}>
              ...
              <input
                ...
                placeholder="Pesquisar por posto, código PY, função ou falha evitada (ex: Posto 3, Airbag, Cinto)..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                style={{ paddingLeft: '2.75rem', width: '100%', fontSize: '0.875rem' }}
              />
            </div>

            <span style={{ fontSize: '0.85rem', fontWeight: 700, color: 'var(--color-text-muted)' }}>
              Exibindo {filteredItems.length} registros
            </span>
          </div>

          {/* Tabela Detalhada de Postos, Poka Yokes e Falhas Evitadas */}
            ...
            {filteredItems.length === 0 ? (
              ...
              <div style={{ overflowX: 'auto' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem', textAlign: 'left' }}>
                  <thead style={{ backgroundColor: '#F8FAFC', borderBottom: '2px solid var(--color-border)' }}>
                    <tr>
                      <th style={{ padding: '0.85rem 1rem', width: '18%' }}>Posto / Linha</th>
                      <th style={{ padding: '0.85rem 1rem', width: '15%' }}>Poka-Yoke Nº</th>
                      <th style={{ padding: '0.85rem 1rem', width: '30%' }}>Função / Especificação Técnica</th>
                      <th style={{ padding: '0.85rem 1rem', width: '25%' }}>Falha Evitada / Prevenção de Erro</th>
                      <th style={{ padding: '0.85rem 1rem', width: '12%', textAlign: 'center' }}>Status / Ação</th>
                    </tr>
                  </thead>
                  <tbody>
        ...
        {/* Rodapé do Modal */}
        <div style={{ backgroundColor: '#F8FAFC', padding: '0.85rem 1.5rem', borderTop: '1px solid #E2E8F0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
